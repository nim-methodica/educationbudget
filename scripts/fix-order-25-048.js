...
const orderNumber = "25-048";
const sourceFile = "פיתוח תוכן במתמטיקה 720  - זוויות 25-048.pdf";
const totalWithoutVat = 1734900;
const vatRate = 0.18;
const totalWithVat = totalWithoutVat * (1 + vatRate);

const lines = [
  { code: "18.1", name: "תוכן טקסטואלי /טקסט עיוני (בסיסי)", quantity: 5, unitCost: 330 },
  { code: "23.1", name: "סרטון מצולם בסיסי", quantity: 26, unitCost: 8500 },
  { code: "23.2", name: "סרטון מצולם מתקדם", quantity: 42, unitCost: 12000 },
  { code: "23.3", name: "סרטון מצולם מורכב", quantity: 21, unitCost: 18000 },
  { code: "27.1", name: "יישומון בסיסי", quantity: 209, unitCost: 1750 },
  { code: "33.1", name: "לומדה בסיסית", quantity: 14, unitCost: 13000 },
...
function main() {
  ...
  order.projectName = "פיתוח תוכן במתמטיקה 720 - זוויות";
